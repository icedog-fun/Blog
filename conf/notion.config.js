...
module.exports = {
  ...
  NOTION_PROPERTY_NAME: {
    ...
    status_invisible:
        process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_INVISIBLE || '未发布', // 当status状态值与此相同时为隐藏发布，可以为中文 ， 除此之外其他页面状态不会显示在博客上
    summary: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SUMMARY || '概要',
    slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || '地址',
    ...
    icon: process.env.NEXT_PUBLIC_NOTION_PROPERTY_ICON || '海报',
